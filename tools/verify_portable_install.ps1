...
Test-RequiredPath -Name "phase B handoff" -RelativePath "docs\architecture\phase-b-main-chain-consolidation.md" -Type "File"
Test-RequiredPath -Name "phase C portable mode" -RelativePath "docs\architecture\phase-c-system-integration-and-portable-mode.md" -Type "File"
Test-RequiredPath -Name "runtime skill" -RelativePath "skills\cst-runtime-cli-optimization\SKILL.md" -Type "File"
Test-RequiredPath -Name "runtime skill CLI entrypoint" -RelativePath "skills\cst-runtime-cli-optimization\scripts\cst_runtime_cli.py" -Type "File"
Test-RequiredPath -Name "runtime skill CLI module" -RelativePath "skills\cst-runtime-cli-optimization\scripts\cst_runtime\cli.py" -Type "File"
Test-RequiredPath -Name "active codex runtime skill copy" -RelativePath ".codex\cst-runtime-cli-optimization\SKILL.md" -Type "File"
Test-RequiredPath -Name "active repo opencode runtime skill copy" -RelativePath ".opencode\skills\cst-runtime-cli-optimization\SKILL.md" -Type "File"
Add-Check -Name "active user opencode runtime skill copy" -Ok (Test-Path -LiteralPath (Join-Path $env:USERPROFILE ".config\opencode\skills\cst-runtime-cli-optimization\SKILL.md") -PathType Leaf) -Message "%USERPROFILE%\.config\opencode\skills\cst-runtime-cli-optimization\SKILL.md"
